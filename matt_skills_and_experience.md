...
- Developed Python visualization library for brand-specific analytics output
...
- Predictive modeling using ML for manufacturing and quality decisions
- Spotfire system administrator
- Led semi-annual APQR (Annual Product Quality Review) meetings
...
- Ensemble methods, PLS, PCA
- Built automated data pipelines (ingestion, cleaning, transformation)
- Presented to senior leadership and cross-functional stakeholders
- Promoted from Data Scientist to Senior Data Scientist (organic, ~5 years)
- Final year: moved to simulation/device optimization team but left shortly after
...
- No manager-of-managers experience (direct reports only)
...
### Modeling Techniques
Random Forest, PLS, PCA, Ensemble Models, LLM Classification (OpenAI), Agent-Based Modeling, Mechanistic Modeling, Symbolic Regression, Multi-Objective Optimization (genetic/evolutionary algorithms)

### Notable Gaps
- SQL is AI-assisted, not strong independently
